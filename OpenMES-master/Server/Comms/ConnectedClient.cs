...
namespace OpenMES_master.Server.Comms
{
    public class ConnectedClient: System.ComponentModel.INotifyPropertyChanged
    {
        ...
        void SessionID(TcpClient client)
        {
